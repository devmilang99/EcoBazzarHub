...
class OrderReceiptScreen extends StatelessWidget {
  ...
  String _buildReceiptText() {
    ...
    buf.writeln('TOTAL    : Rs. ${order.totalAmount.toStringAsFixed(2)}');
    buf.writeln('================================');
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              // 2. Shop Info (New)
              _buildSectionHeader('Seller Information', Icons.storefront_rounded, isDark),
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: isDark ? Colors.grey[800]! : Colors.green.shade100),
                ),
                child: Row(
                  children: [
                    Container(
              ...
              // 3. Items Summary
              _buildSectionHeader('Order Summary', Icons.summarize_outlined, isDark),
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...order.items
                        .map((item) =>
                            _ReceiptItemRow(item: item, isDark: isDark))
                        ,
                  ],
                ),
              ),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color:
                      isDark ? Colors.grey[850] : const Color(0xFFF7FAF7),
                    ...
                    SizedBox(
                      ...
                      child: Row(
                        ...
                        children: List.generate(40, (i) {
                          final rng =
                              math.Random(order.id.hashCode + i * 7);
